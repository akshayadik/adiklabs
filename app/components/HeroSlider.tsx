...
const slides = [
  ...
  },
  {
    ...
    title: (
      <>
        Hi, I’m <span className="text-violet">Akshay</span>
      </>
    ),
    ...
    ctaPrimary: { text: "Work With Me", href: "/contact", event: "click_work_with_me" },
  ...
  },
  {
    ...
    points: [
      "I build systems that scale businesses beyond dependency",
      "I focus on long-term growth, not short-term hacks",
      "I combine technology + strategy to create leverage",
    ],
          ...
          {slides.map((_, i) => (
            <button
              ...
              className={`h-1.5 transition-all rounded-full ${
                current === i ? "w-10 bg-blue" : "w-4 bg-gray-300"
              }`}
            />
          ))}
        </div>
